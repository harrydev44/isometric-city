...
import { Pedestrian, PedestrianDestType, WorldRenderState, PEDESTRIAN_MIN_ZOOM, PEDESTRIAN_SKIN_COLORS, PEDESTRIAN_SHIRT_COLORS } from '@/components/game/types';
...
export function usePedestrians(
  ...
  const spawnPedestrian = useCallback(() => {
    ...
    let direction: 'north' | 'east' | 'south' | 'west' = 'south';
  ...
  }, [spawnPedestrian, isMobile, worldStateRef, gridVersionRef, cachedRoadTileCountRef]);
