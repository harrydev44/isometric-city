...
// Water asset paths (multiple variants for visual variety)
// NOTE: Keep WATER_ASSET_PATH for backwards compatibility.
export const WATER_ASSET_PATHS = ['/assets/water.webp', '/assets/water2.webp', '/assets/water3.webp'] as const;
export const WATER_ASSET_PATH = WATER_ASSET_PATHS[0];
