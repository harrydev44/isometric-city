...
import { CoasterMobileToolbar } from './mobile/CoasterMobileToolbar';
import { CoasterMobileTopBar } from './mobile/CoasterMobileTopBar';
    ...
    return (
      <TooltipProvider>
        <div className="w-full h-full overflow-hidden bg-background flex flex-col">
          {/* Mobile Top Bar */}
          <CoasterMobileTopBar onExit={onExit} />
