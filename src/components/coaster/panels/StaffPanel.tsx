...
import { T, Var, Num, useMessages, useGT } from 'gt-next';
          ...
          <ScrollArea className="h-48 rounded-md border border-border/50">
            <div className="p-3 space-y-2">
              ...
              {staff.map((member) => {
                ...
                const patrolStatusLabel = member.patrolArea ? gt('Patrol area') : gt('Park-wide');
                return (
                    ...
                    <div>
                      ...
                      <T>
                        <div className="text-xs text-muted-foreground capitalize">
                          <Var>{staffTypeLabel}</Var> · <Var>{patrolStatusLabel}</Var>
                        </div>
                      </T>
                    </div>
