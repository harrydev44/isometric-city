                ...
                return (
                  <div key={ride.id} className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <T>
                        <div className="text-xs text-muted-foreground">
                          <Var>{estimatedWait > 0 ? gt('{count} min wait', { count: estimatedWait }) : gt('No wait')}</Var> · $<Num>{ride.price}</Num> ticket ·{' '}
                          <Num>{reliabilityPercent}</Num>% reliable
                        </div>
                      </T>
                      <T>
                        <div className="text-xs text-muted-foreground">
                          <Num>{uptimePercent}</Num>% uptime · <Num>{ride.stats.totalRiders}</Num> riders
                        </div>
                      </T>
                    </div>
