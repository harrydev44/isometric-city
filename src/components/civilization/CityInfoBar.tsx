 ...
 * Strategy game style with navigation - Cyan/teal theme
 */
...
export function CityInfoBar({
  ...
  return (
    <div className="bg-[#0d1f35]/95 backdrop-blur-sm border-2 border-cyan-600/50 rounded-t-lg shadow-2xl">
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-cyan-900/50">
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={onPrev}
            className="w-8 h-8 bg-[#0a1628] hover:bg-cyan-900/50 border border-cyan-600/50 rounded flex items-center justify-center text-cyan-400 font-bold transition-colors"
          >
            ◀
          </button>
      ...
      <div className="flex items-center justify-center gap-6 px-4 py-2">
        <div className="flex items-center gap-2">
          <span className="text-cyan-700 text-xs">POP</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-cyan-300 font-bold">{currentAgent.performance.totalMoney.toLocaleString()}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-cyan-700 text-xs">BLDG</span>
          <span className="text-cyan-400 font-bold">{currentAgent.performance.buildingsPlaced}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-cyan-700 text-xs">PEAK</span>
          <span className="text-cyan-300 font-bold">{currentAgent.performance.peakPopulation.toLocaleString()}</span>
        </div>
      </div>
    </div>
  );
