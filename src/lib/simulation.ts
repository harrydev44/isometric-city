...
const CITY_NAMES = [
  ...
  'Cliffside', 'Meadowbrook', 'Highland', 'Seaside', 'Forest Hills', 'Clearwater', 'Brighton',
  'Summit', 'Bridgeport', 'Lakeshore', 'Hilltop', 'Greenfield', 'Oakdale', 'Pinecrest',
  ...
  'Forest Park', 'Clearview', 'Brightwood', 'Summitville', 'Bridgeview', 'Lakeview',
];
...
function generateOceans(grid: Tile[][], size: number, seed: number): WaterBody[] {
  const waterBodies: WaterBody[] = [];
  const oceanChance = 0.4; // 40% chance of having ocean connections per edge
