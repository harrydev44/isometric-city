...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 80, description: 'Lay dual-track rail network' },
  ...
  rail_station: { name: 'Rail Station', cost: 1200, description: 'Passenger rail station (1x1)', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail_station: { maxPop: 0, maxJobs: 18, pollution: 1, landValue: 18 },
